...
## IPv4
ip addr add 10.10.2.6/30 dev eth1.20
ip route add 10.10.1.4/30 via 10.10.2.5

## IPv6
ip addr add 2001:c0de:10:4::2/64 dev eth1.20
ip route add 2001:c0de:10:3::/64 via 2001:c0de:10:4::1
